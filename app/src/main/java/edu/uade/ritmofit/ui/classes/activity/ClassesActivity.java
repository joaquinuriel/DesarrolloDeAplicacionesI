...
public class ClassesActivity extends AppCompatActivity {
    ...
    private void setupDynamicFilters(List<Class> clases) {
        ...
        spSite.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_dropdown_item_1line, sedeList));
        spDiscipline.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_dropdown_item_1line, disciplinaList));
    ...
    private void refreshList() {
        if (filtered.isEmpty()) {
            ...
            rvClasses.setAdapter(new ClassesAdapter(filtered, item -> {
                ClassDetailActivity.start(this, item);
            }));
        }
    }
